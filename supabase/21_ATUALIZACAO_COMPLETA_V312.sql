-- ProteínaFlow V3.12 — atualização completa
-- Executa a base robusta de XML da V3.11 e depois a migração de Produção/Sobra por proteína da V3.12.
-- Os blocos são idempotentes e preservam os dados existentes.
